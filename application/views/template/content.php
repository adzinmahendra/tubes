          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Gratis Ongkos Kirim</h3>
                <span>Di Pemesanan lebih dari Rp 200.000</span>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
				...
				<div class="row">
							...
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(<?php echo base_url()?>assets/images/category.jpg);">
									<div class="text text-center">
										...
										<p><a href="<?= base_url('index.php/shop/'); ?>" class="btn btn-primary">Beli Sekarang</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(<?php echo base_url()?>assets/images/category-2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Sayur-sayuran</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(<?php echo base_url()?>assets/images/category-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Olahan</a></h2>
							</div>
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(<?php echo base_url()?>assets/images/category-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Lain-lain</a></h2>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Produk yang Ditampilkan</span>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>Berikut adalah testimonial yang sangat sering berbelannja di website kami</p>
          </div>
        </div>
