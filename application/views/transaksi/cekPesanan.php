    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <h3 class="heading">Kode Resi</h3>
              <form class="form" action="<?= base_url('index.php/user/pesananDiterima')?>" method="post" enctype="multipart/form-data">
                  <!-- <input type="file" name="bukti_bayar" value="" class="form-input" required> -->
                  <h4><?= $transaksi->resi?></h4>
                  <br>
                  <input type="checkbox" id="setuju" name="setuju" value="4" required>
                  <label for="vehicle1"> Pesanan telah saya terima</label><br>
                  <input type="hidden" name="id_pesanan" value="<?= $pesanan->id_pesanan?>">
                  <!-- <a class="btn btn-success" href="#">Pesanan Diterima</a> -->
                  <br>
                  <!-- <button class="btn btn-success" type="button" name="button">Pesanan Diterima</button> -->
                  <input type="submit" name="" value="Pesanan Diterima" class="btn btn-success">
              </form>
            </div>
          </div>
