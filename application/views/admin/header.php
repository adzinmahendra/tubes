  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url()?>index.php/">
        ...
        <div class="sidebar-brand-text mx-3">D-Farm<sup>tm</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Data Konsumen</h6>
            <!-- <a class="collapse-item" href="<?= base_url('index.php/Konsumen/daftarKonsumen');?>">Dafrtar Konsumen</a> -->
            <a class="collapse-item" href="<?= base_url('index.php/Konsumen/laporanKonsumen');?>">Laporan Konsumen</a>
            <a class="collapse-item" href="<?= base_url('index.php/konsumen/pesanan');?>">Pesanan</a>
            <!-- <a class="collapse-item" href="<?= base_url('index.php/Konsumen/informasiProduk');?>">Informasi Produk</a> -->
            <a class="collapse-item" href="<?= base_url('index.php/Konsumen/pesan');?>">Kotak Pesan</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?= base_url().'assets_admin/img/gambar_user/'.$this->session->userdata("gambar_user") ?? "https://source.unsplash.com/QAB-WJcbgJk/60x60"?>">
              </a>
