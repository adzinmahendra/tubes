...
<div class="card shadow mb-4">
    ...
    <div class="collapse" id="collapseCardExample" style="" width="100%">
        <div class="card-body">
    ...
    <div class="card-footer d-flex justify-content-end">
        <!-- <a href="<?= base_url()?>index.php/Kelola/cekListKategori/" class="btn btn-primary position-bottom">Cek</a> -->
        <!-- <a href="<?= base_url()?>index.php/Kelola/hapusKategori/" class="btn btn-danger position-bottom">Hapus</a> -->
    </div>
</div>
</div>
